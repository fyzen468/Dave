...
function endResult(player1Choice, player2Choice) {
    if (player1Choice.name === player2Choice.name) {
        outcome.innerHTML = `<img src="${decision[0].image}" alt="Draw" style="width: 80%;"> <h3>DRAW!!</h3>`;
        return 'DRAW!!';
    } else if (
        ...
        player1Score++;
        outcome.innerHTML = `<img src="${decision[1].image}" alt="Player 1 Wins" style="width: 80%;"> <h3>PLAYER 1 WINS!!</h3>`;
        return 'PLAYER 1 WINS!!';
    } else {
        player2Score++;
        outcome.innerHTML = `<img src="${decision[1].image}" alt="Player 2 Wins" style="width: 80%;"> <h3>PLAYER 2 WINS!!</h3>`;
